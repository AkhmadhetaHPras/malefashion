              ...
              <div class="col-xxl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form>                      
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Product Name</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Link Youtube</h6></label>
                        <div class="col-sm-10">                          
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Description</h6></label>
                        <div class="col-sm-10">
                          <textarea id="description-product" class="form-control" rows="3" placeholder="Product details"></textarea>                         
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Short description</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Prices</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Category</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Brands</h6></label>
                        <div class="col-sm-10">
                          <select id="gender" class="form-select " required>
                            <option value="" data-select2-id="2">Select</option>
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Tags</h6></label>
                        <div class="col-sm-10">                                                    
                          <div class="row">
                            <div class=" col-sm-2">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Slugs</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Thumbnail image</h6></label>
                        <div class="col-sm-10">
                          <div class="input-group">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Display 1</h6></label>
                        <div class="col-sm-10">
                          <div class="input-group">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Display 2</h6></label>
                        <div class="col-sm-10">
                          <div class="input-group">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Display 3</h6></label>
                        <div class="col-sm-10">
                          <div class="input-group">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Display 4</h6></label>
                        <div class="col-sm-10">
                          <div class="input-group">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Display 5</h6></label>
                        <div class="col-sm-10">
                          <div class="input-group">
