  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Menswear</span>
          </a>
        ...
        <li class="menu-item active open">
          ...
          <ul class="menu-sub lead">
            <li class="menu-item">
              <a href="app-product-add.html" class="menu-link">
                <div data-i18n="Account">Add</div>
              </a>
            </li>
            <li class="menu-item active">
              <a href="app-product-list.html" class="menu-link">
        ...
        <!-- Users Start -->
          <li class="menu-item">
            ...
            <ul class="menu-sub lead">
              <li class="menu-item">
                <a href="app-user-add.html" class="menu-link" target="_blank">
                  <div data-i18n="Basic">Add</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="app-user-list.html" class="menu-link" target="_blank">
          ...
          <li class="menu-item">
            <a href="pages-misc-under-maintenance.html" target="_blank"
              class="menu-link">
      ...
      <div class="layout-page">
        ...
        <nav
          class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme lead"
          id="layout-navbar">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">              
              <li class="nav-item">
                <a href="#" data-size="large"><strong>John</strong></a>
              </li>              
              <!-- User -->
                    ...
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting sorting_desc" tabindex="0" aria-controls="DataTables_Table_0"rowspan="1" 
                          colspan="1" style="width: 80px;" aria-label="User: activate to sort column ascending" aria-sort="descending">#ID</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                          style="width: 212px;" aria-label="Role: activate to sort column ascending">Products</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                          style="width: 152px;" aria-label="Plan: activate to sort column ascending">Category</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                          style="width: 204px;" aria-label="Billing: activate to sort column ascending">Tags</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                          style="width: 149px;" aria-label="Status: activate to sort column ascending">Harga</th>
                          ...
                          <div class="d-flex justify-content-start align-items-center">                            
                            ...
                            <div class="avatar-wrapper">
                              <div class="avatar avatar-sm me-3">
                                <img src="../assets/img/icons/products/DUFFEL-BAG_ESSENTIALS_LOGO EKSTRA_KECIL.jpg" alt="Avatar" class="rounded-circle">
                              </div>
                            </div>
                            <!-- Name & email-->
                      ...
                      <tr class="even">
                        ...
                        <td class="sorting_1">
                          <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="avatar-wrapper">
                              <div class="avatar avatar-sm me-3">
                                <img src="../assets/img/icons/products/BUCKET-HAT.jpg" alt="Avatar" class="rounded-circle">
                              </div>
                            </div>
                            <div class="d-flex flex-column">
                              <a href="app-user-view-account.html" class="text-body text-truncate"><span class="fw-semibold">BUCKET HAT</span></a>
                              <small class="text-muted">Unisex;Men</small>
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div class="d-inline-block"><button class="btn btn-sm btn-icon dropdown-toggle hide-arrow"
                      ...
                      <tr class="odd">
                        ...
                        <td class="sorting_1">
                          <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="avatar-wrapper">
                              <div class="avatar avatar-sm me-3">
                                <img src="../assets/img/avatars/6.png" alt="Avatar" class="rounded-circle"></div>
                            </div>
                            <div class="d-flex flex-column"><a href="app-user-view-account.html"
                                class="text-body text-truncate"><span class="fw-semibold">Wesley
                      ...
                      <tr class="even">
                        ...
                        <td class="sorting_1">
                          <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="d-flex flex-column"><a href="app-user-view-account.html"
                                class="text-body text-truncate"><span class="fw-semibold">Vladamir
                      ...
                      <tr class="odd">
                        ...
                        <td class="sorting_1">
                          <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="d-flex flex-column"><a href="app-user-view-account.html"
                                class="text-body text-truncate"><span class="fw-semibold">Tyne Widmore</span></a><small
                                class="text-muted">Unisex;Men</small></div>
                          </div>
                        </td>
                        <td><span class="text-truncate d-flex align-items-center"><span
                              class="badge badge-center rounded-pill bg-label-warning w-px-30 h-px-30 me-2">
                      ...
                      <tr class="even">
                        ...
                        <td class="sorting_1">
                          <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="d-flex flex-column"><a href="app-user-view-account.html"
                                class="text-body text-truncate"><span class="fw-semibold">Travus
                      ...
                      <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                        <ul class="pagination">
                          ...
                          <li class="paginate_button page-item next" id="DataTables_Table_0_next"><a href="#"
                              aria-controls="DataTables_Table_0" data-dt-idx="6" tabindex="0" class="page-link">Next</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <span class="select2 select2-container select2-container--default" dir="ltr"data-select2-id="1" style="width: 335px;">
                        <span class="selection">
                          <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true"
                            aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-country-container">
