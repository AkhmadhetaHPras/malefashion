              ...
              <div class="col-xxl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Photo</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Username</h6></label>
                        <div class="col-sm-10">
                          <div class="input-group">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Full Name</h6></label>
                        <div class="col-sm-10">                          
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Email</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Contact</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Gender</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Birth</h6></label>
                        <div class="col-sm-10">
                          <input type="date" id="birth" class="form-control" placeholder="dd/mm/yyy" aria-label="jdoe1" name="birth">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Country</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Role</h6></label>
                        <div class="col-sm-10">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name"><h6>Password</h6></label>
                        <div class="col-sm-10">
