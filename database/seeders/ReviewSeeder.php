    ...
    public function run()
    {
        $datas = [
            [
                ...
                'review' => 'The material seems pretty solid. The brim is absolutely huge and kept the sun off my neck while I was outside today. I like the netting on the sides of the hat, too. Kept my head nice and cool. Also, I have a massive head and the hat fit just fine. It is also adjustable with some elastic in the back. The thing even has a chin strap for windy days.',
                'rating' => 5,
            ],
            [
                'id' => '2',
