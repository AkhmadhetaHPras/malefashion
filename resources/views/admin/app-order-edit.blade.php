            ...
            <div class="row invoice-edit">
                      ...
                      <div class="col-md-6">
                        <dl class="row mb-2">
                          ...
                          <dd class="col-sm-6 d-flex justify-content-md-end">
                            <div class="w-px-150">
                              <input type="text" class="form-control" disabled="" placeholder="3492" value="3492"
                                id="invoiceId">
                            </div>
                          </dd>
                          <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end">
                          ...
                          <dd class="col-sm-6 d-flex justify-content-md-end">
                            <div class="w-px-150">
                              <input type="text" class="form-control invoice-date flatpickr-input"
                          ...
                          <dd class="col-sm-6 d-flex justify-content-md-end">
                            <div class="w-px-150">
                              <input type="text" class="form-control due-date flatpickr-input" placeholder="YYYY-MM-DD"
                                readonly="readonly">
                            </div>
                          </dd>
                        </dl>
                            ...
                            <div class="row w-100 m-0 p-3">
                              <div class="col-md-6 col-12 mb-md-0 mb-3 ps-md-0">
                                ...
                                <textarea class="form-control"
                                  rows="2">The most developer friendly &amp; highly customizable HTML5 Admin</textarea>
                              </div>
                              <div class="col-md-3 col-12 mb-md-0 mb-3">
                                <p class="mb-2 repeater-title">Cost</p>
                                <input type="number" class="form-control invoice-item-price mb-2" value="24"
                                  placeholder="24" min="12">
                                <div>
                                  <span>Discount:</span>
                                  <span class="discount me-2">0%</span>
                                  <span class="tax-1 me-2" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                    data-bs-original-title="Tax 1">0%</span>
                                  <span class="tax-2" data-bs-toggle="tooltip" data-bs-placement="top" title=""
              ...
              <div class="col-lg-3 col-12 invoice-actions">
                ...
                <div>
                  ...
                  <!-- <div class="form-control-col mb-4">
                    COD
                  </div> -->
